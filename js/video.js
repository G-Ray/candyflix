...
vjs.TextTrack.prototype.load = function(){
  ...
  if (this.readyState_ === 0) {
    ...
    videojs.biggerSubtitles = videojs.Button.extend({
        /** @constructor */
        init: function (player, options) {
    ...
    videojs.smallerSubtitles = videojs.Button.extend({
        /** @constructor */
        init: function (player, options) {
            videojs.Button.call(this, player, options);
            this.on('click', this.onClick);
    ...
    videojs.biggerSubtitles.prototype.onClick = function () {
    ...
    videojs.smallerSubtitles.prototype.onClick = function () {
		  var $subs = $('#video_player.video-js .vjs-text-track-display');
		  var font_size = parseInt($subs.css('font-size'));
		  font_size = font_size - 3;
		  $subs.css('font-size', font_size+'px');
    ...
    var videojs_createButton = function(clsname) {
        var props = {
            className: 'vjs-control vjs-menu-button ' + (clsname || ''),
            innerHTML: '<div class="vjs-control-content icon text-sizing"><span class="vjs-control-text"></span></div>',
            role: 'button',
            tabIndex: 0
        };
    ...
    videojs.plugin('biggerSubtitles', function () {
        var options = {
            'el': videojs_createButton('biggerSubtitles')
        };
        var btn = new videojs.biggerSubtitles(this, options);
        this.controlBar.el().appendChild(btn.el());
    });


    videojs.plugin('smallerSubtitles', function () {
        var options = {
            'el': videojs_createButton('smallerSubtitles')
        };
